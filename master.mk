...
GTIS = quiet up top down1 down2

ORIGIN = /nfs/melkor/d1/guenther/soft/XMM-data-reduction-scripts
SRCFILES = /nfs/melkor/d1/guenther/projects/Chandraprojects/RWAur
FLARE = 0401870301
...
epictimes : $(GTIS)
	cp $(SRCFILES)/0401870301_gti.src 0401870301/
	$(MAKE) -C $< SRCFILE=0401870301_gti.src SRC=$< GTIFILE=$<.gti EPIC

# in /media/MAX/moritz/obs/XMM/
# make subdirs -f /nfs/melkor/d1/guenther/projects/Chandraprojects/RWAur/master.mk -k -j 3
